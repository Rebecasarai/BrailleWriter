...
public class TensorFlowImageClassifier implements Classifier {
  ...
  @Override
  public List<ObjectRecognition> recognizeImage(final Bitmap bitmap) {
    ...
    PriorityQueue<ObjectRecognition> pq =
        new PriorityQueue<ObjectRecognition>(
            3,
            new Comparator<ObjectRecognition>() {
              @Override
              public int compare(ObjectRecognition lhs, ObjectRecognition rhs) {
